...
@Component({
  selector: 'app-delete-search-invoices',
  templateUrl: './delete-search-invoices.component.html',
})
export class DeleteSearchInvoicesComponent implements OnInit {
  doClean = false;
  ...
  invoiceTypes: string[] = ['Todos', 'Ingresado', 'Aprobado', 'Confirmado'];
